package tooltwist.training_noreen.productionHelpers;
...
public class HelloNoreenProductionHelper extends WbdProductionHelper
{
	...
	public HelloNoreenProductionHelper(Properties prop)
	{
		super(prop);
	}
