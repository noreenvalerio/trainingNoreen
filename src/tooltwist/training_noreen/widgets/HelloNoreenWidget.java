package tooltwist.training_noreen.widgets;

import tooltwist.training_noreen.productionHelpers.HelloNoreenProductionHelper;
 ...
 * Hello World Noreen
 */
public class HelloNoreenWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "helloNoreen_preview.html";
	private static final String SNIPPET_DESIGN = "helloNoreen_design.html";
	private static final String SNIPPET_PRODUCTION = "helloNoreen_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "helloNoreen_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "helloNoreen_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HelloNoreenProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(HelloNoreenProductionHelper.class.getName()));
			}
		}
